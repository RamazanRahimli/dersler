...
//     if (students[index].grade ==  95 && students[index].grade == 100) {
...
// const  myArray = IP.filter(x => x.customer.Id == 'ERNSH');

// console.log(myArray.length);

// const newArr = IP.employeeId.sort((a, b) => a - b);
// console.log(newArr);

//  const newArry = newArr.filter(x=> x.details.length>3)
// console.log(newArry.length);

// const newArry = newArr.filter(x=> x.freight <  1)
// console.log(newArry.length);
